...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    config = { "\27LJ\2\nú\v\0\0\4\0\t\0\0166\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\0029\0\3\0005\2\4\0B\0\2\0016\0\5\0009\0\6\0009\0\a\0'\2\b\0+\3\1\0B\0\3\1K\0\1\0‰\t            nnoremap <silent> gd <cmd>lua require'lspsaga.provider'.preview_definition()<CR>\n            nnoremap <silent> gD <cmd>lua vim.lsp.buf.definition()<CR>\n            nnoremap <silent> <leader>k <cmd>lua vim.lsp.buf.hover()<CR>\n            nnoremap <silent> 1gD <cmd>lua vim.lsp.buf.type_definition()<CR>\n            nnoremap <silent> gr <cmd>lua vim.lsp.buf.references()<CR>\n            nnoremap <silent> g0 <cmd>lua vim.lsp.buf.document_symbol()<CR>\n            nnoremap <silent> gf <cmd>lua vim.lsp.buf.formatting()<CR>\n            nnoremap <silent> [d <cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_prev()<CR>\n            nnoremap <silent> ]d <cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_next()<CR>\n\n            \" TODO: Get working\n            nnoremap <silent> gh <cmd>lua require'lspsaga.provider'.lsp_finder()<CR>\n\n            \" nnoremap <silent> gd <cmd>lua vim.lsp.buf.declaration()<CR>\n            \" nnoremap <silent> gD <cmd>lua vim.lsp.buf.implementation()<CR>\n            \" nnoremap <silent> <c-]> <cmd>lua vim.lsp.buf.definition()<CR>\n            \" nnoremap <silent> <leader>K <cmd>lua vim.lsp.buf.signature_help()<CR>\n            \" nnoremap <silent> gr <cmd>lua vim.lsp.buf.references()<CR>\n          \14nvim_exec\bapi\bvim\1\0\4\14warn_sign\bÔÅ™\15infor_sign\bÔÅö\15error_sign\bÔÄç\14hint_sign\b‚û§\18init_lsp_saga\flspsaga\vtb.lsp\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\nú\v\0\0\4\0\t\0\0166\0\0\0'\2\1\0B\0\2\0016\0\0\0'\2\2\0B\0\2\0029\0\3\0005\2\4\0B\0\2\0016\0\5\0009\0\6\0009\0\a\0'\2\b\0+\3\1\0B\0\3\1K\0\1\0‰\t            nnoremap <silent> gd <cmd>lua require'lspsaga.provider'.preview_definition()<CR>\n            nnoremap <silent> gD <cmd>lua vim.lsp.buf.definition()<CR>\n            nnoremap <silent> <leader>k <cmd>lua vim.lsp.buf.hover()<CR>\n            nnoremap <silent> 1gD <cmd>lua vim.lsp.buf.type_definition()<CR>\n            nnoremap <silent> gr <cmd>lua vim.lsp.buf.references()<CR>\n            nnoremap <silent> g0 <cmd>lua vim.lsp.buf.document_symbol()<CR>\n            nnoremap <silent> gf <cmd>lua vim.lsp.buf.formatting()<CR>\n            nnoremap <silent> [d <cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_prev()<CR>\n            nnoremap <silent> ]d <cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_next()<CR>\n\n            \" TODO: Get working\n            nnoremap <silent> gh <cmd>lua require'lspsaga.provider'.lsp_finder()<CR>\n\n            \" nnoremap <silent> gd <cmd>lua vim.lsp.buf.declaration()<CR>\n            \" nnoremap <silent> gD <cmd>lua vim.lsp.buf.implementation()<CR>\n            \" nnoremap <silent> <c-]> <cmd>lua vim.lsp.buf.definition()<CR>\n            \" nnoremap <silent> <leader>K <cmd>lua vim.lsp.buf.signature_help()<CR>\n            \" nnoremap <silent> gr <cmd>lua vim.lsp.buf.references()<CR>\n          \14nvim_exec\bapi\bvim\1\0\4\14warn_sign\bÔÅ™\15infor_sign\bÔÅö\15error_sign\bÔÄç\14hint_sign\b‚û§\18init_lsp_saga\flspsaga\vtb.lsp\frequire\0", "config", "nvim-lspconfig")
...
try_loadstring("\27LJ\2\nÈ\4\0\0\4\0\r\0\0276\0\0\0009\0\1\0)\1\0\0=\1\2\0006\0\0\0009\0\1\0'\1\4\0=\1\3\0006\0\0\0009\0\1\0'\1\6\0=\1\5\0006\0\0\0009\0\1\0'\1\6\0=\1\a\0006\0\0\0009\0\1\0'\1\t\0=\1\b\0006\0\0\0009\0\n\0009\0\v\0'\2\f\0+\3\1\0B\0\3\1K\0\1\0\2            set signcolumn=yes\n            highlight! link SignifySignChange GruvboxBlueSign\n\n            \" nifty hunk motions\n            omap ic <Plug>(signify-motion-inner-pending)\n            xmap ic <Plug>(signify-motion-inner-visual)\n            omap ac <Plug>(signify-motion-outer-pending)\n            xmap ac <Plug>(signify-motion-outer-visual)\n          \14nvim_exec\bapi\bÔëÑ\24signify_sign_change#signify_sign_delete_first_line\bÔíã\24signify_sign_delete\bÔëç\21signify_sign_add\21signify_priority\6g\bvim\0", "config", "vim-signify")
